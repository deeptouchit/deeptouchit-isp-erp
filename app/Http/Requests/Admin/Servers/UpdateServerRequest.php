...
class UpdateServerRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user() && ($this->user()->role === 'admin' || $this->user()->can('servers.edit'));
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'hostname' => ['sometimes', 'required', 'string', 'max:255', 'regex:/^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])(\.([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9\-]{0,61}[a-zA-Z0-9]))*$/'],
